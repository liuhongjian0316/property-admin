      ...
      <el-col :span="24" style="margin-top: 20px">
        <el-card style="width: 98%;margin: 0 auto;">
          <vxe-table
            ...
            export-config
            import-config>
            <vxe-table-column field="workOrderCsId" title="编号"></vxe-table-column>
              ...
              <template v-slot="{ row }">
                <el-row>
                  <el-col :span="12" v-if="row.state == 'unmark'">
                    <span></span><vxe-button size="mini" content="待评价" @click="openEPage(row.workOrderCsId)"></vxe-button>
                  </el-col>
                  <el-col :span="12"><vxe-button size="mini" content="详情" @click="details(row.workOrderCsId)"></vxe-button></el-col>
                </el-row>
              </template>
            </vxe-table-column>
          </vxe-table>
...
<script>
    export default {
        ...
        methods:{
            ...
            getData(){
                this.$axios.get('/api/sp/shop/tel/order/finish/'+this.$data.currentPage+'/'+this.$data.pageSize+"/"+1)
                    .then(function (response) {
            ...
            openEPage(id){
                ...
                this.$data.evaluateForm.workOrderCsId = id;
            },
            //评分改变事件
            changeColor(value){
            ...
            submitEva(formName){
                ...
                this.$axios.post('/api/sp/shop/tel/order/evaluate/',this.$data.evaluateForm)
                    .then(function (response) {
