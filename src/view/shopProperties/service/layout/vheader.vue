      ...
      <div class="right">
        ...
        <el-dropdown trigger="click">
          <span class="el-dropdown-link">
            {{customerServiceName}}<i class="el-icon-arrow-down el-icon--right"></i>
          </span>
        ...
        <!--welcome information-->
        <span style="font-size: 12px; color: grey">欢迎 <b>{{customerServiceName}}</b>访问物业管理系统</span>
        <!--消息通知-->
        <el-dropdown trigger="click">
          <span class="el-dropdown-link">
...
<script>
    export default {
        ...
        methods:{
            getInfo(){
                let item = localStorage.getItem("serviceinfo");
                this.$data.customerServiceName = JSON.parse(item).customerServiceName;
            },
            exit(){
