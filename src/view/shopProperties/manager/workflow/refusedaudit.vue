        ...
        <el-col :span="24" style="margin-top: 20px">
          <el-card style="width: 98%;margin: 0 auto;">
            <vxe-table
              ...
              export-config
              import-config>
              <vxe-table-column field="workOrderId" title="派单编号"></vxe-table-column>
                    ...
                    <el-col :span="8">
                      <el-dropdown trigger="click">
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item><vxe-button size="mini" content="审核" @click="details2(row.workOrderId)"></vxe-button></el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
                    </el-col>
                    <el-col :span="8"><vxe-button size="mini" content="详情" @click="details(row.workOrderId)"></vxe-button></el-col>
                  </el-row>
                </template>
              </vxe-table-column>
            </vxe-table>
...
<script>
    export default {
        ...
        methods:{
            ...
            getData(){
                this.$axios.get('/api/sp/manager/order/auditRefused/'+this.$data.currentPage+'/'+this.$data.pageSize)
                    .then(function (response) {
