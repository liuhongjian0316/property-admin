      ...
      <el-col :span="24" style="margin-top: 20px">
        <el-card style="width: 98%;margin: 0 auto;">
          <vxe-table
            ...
            export-config
            import-config>
            <vxe-table-column field="work_order_cs_id" title="报修单编号"></vxe-table-column>
            ...
            <vxe-table-column title="操作">
              <template v-slot="{ row }">
                <el-row>
                  ...
                  <el-col :span="12"><vxe-button size="mini" content="详情" @click="details(row.work_order_cs_id)"></vxe-button></el-col>
                </el-row>
              </template>
            </vxe-table-column>
          </vxe-table>
...
<script>
    export default {
        ...
        methods:{
            ...
            getData(){
                  this.$axios.get('/api/sp/manager/tel/untreat/'+this.$data.currentPage+'/'+this.$data.pageSize)
                    .then(function (response) {
            ...
            choice(id){
                ...
                this.$axios.post('/api/sp/manager/tel/handleOrder',this.$data.rowDate)
                    .then(function (response) {
