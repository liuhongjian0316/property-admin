                  ...
                  <el-col :span="12">
                    <el-dropdown trigger="click">
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item><vxe-button size="mini" content="接单" @click="receiveOrder(row)"></vxe-button></el-dropdown-item>
                        <el-dropdown-item><vxe-button size="mini" content="拒单" @click="refuseOrder(row)"></vxe-button></el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                  </el-col>
        ...
        methods:{
            ...
            getData(){
                let item = localStorage.getItem("repairinfo");
                  this.$axios.get('/api/sp/repair/untreat/'+this.$data.currentPage+'/'+this.$data.pageSize+"/"+JSON.parse(item).repairWorkerId)
                    .then(function (response) {
            ...
            receiveOrder(row){
                this.$modal.confirm('详细查看派单详情之后，确认操作').then(type => {
                    if( type == 'confirm'){
                        this.$axios.post('/api/sp/repair/order/receive/',row)
                            .then(function (response) {
